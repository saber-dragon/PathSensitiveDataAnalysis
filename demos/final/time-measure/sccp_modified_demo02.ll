...
if.end.split3:                                    ; preds = %if.end.p1, %if.end.p2
...
exit:                                             ; preds = %if.end.split
  ret i32 %r

if.end.p2:                                        ; preds = %if.else
  %z.p2 = add nsw i32 0, %a
  %w.p2 = add nsw i32 0, %add1
  br label %if.end.split3

if.end.p1:                                        ; preds = %if.then
  %z.p1 = add nsw i32 10, %a
  %w.p1 = add nsw i32 10, %add1
  br label %if.end.split3
}
